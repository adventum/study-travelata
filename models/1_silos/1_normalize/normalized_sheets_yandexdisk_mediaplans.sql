...
parseDateTime(JSONExtractString(_airbyte_data, 'Period_start'), '%Y-%m-%d') as Period_start,
parseDateTime(JSONExtractString(_airbyte_data, 'Period_end'), '%Y-%m-%d') as Period_end,
