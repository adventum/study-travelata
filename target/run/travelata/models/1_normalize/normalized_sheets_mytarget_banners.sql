  ...
  create view travelata.normalized_sheets_mytarget_banners__dbt_tmp 
...
from
(select *,'travelata._airbyte_raw_sheets_mytarget_travelata_normalize_mt_banners' as __table_name
