  ...
  create view travelata.normalize_sheets_yandexdisk_othercosts 
...
from 
(select *, '_airbyte_raw_sheets_default_travelataydothercosts_yandexdisk_othercosts_new' as __table_name
from travelata._airbyte_raw_sheets_default_travelataydothercosts_yandexdisk_othercosts_new)
  )